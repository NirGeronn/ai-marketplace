...
const SOLUTIONS = [
  {
    ...
    requirements: ["Salesforce credentials", "AWS account access", "Customer data pipeline access"],
    featured: true,
  },
  {
    ...
    requirements: ["License to Claude", "Brand guidelines document", "Campaign manager access"],
    featured: true,
  },
  {
    ...
    requirements: ["Security team approval", "VPN access", "Datadog credentials"],
    featured: true,
  },
  {
    ...
    requirements: ["AWS account access", "Airflow credentials", "Data warehouse read access"],
  },
  {
    ...
    ownerName: "Omer Tal",
    tags: ["nlp", "rag", "llm"],
    requirements: ["Salesforce credentials", "License to Claude", "Confluence API key"],
  },
  {
    ...
    requirements: ["Datadog credentials", "Attribution API access"],
  },
  {
    ...
    requirements: ["GitHub account", "License to Claude", "Repository admin access"],
  },
  {
    ...
    requirements: ["Apple developer account", "SKAdNetwork postback access"],
  },
  {
    ...
    requirements: ["Zendesk API key", "Slack bot token"],
  },
  {
    ...
    requirements: ["Salesforce credentials", "Finance dashboard access", "Data warehouse read access"],
  },
  {
    ...
    requirements: ["Campaign manager access"],
  },
  {
    ...
    requirements: ["Confluence API key", "Slack bot token", "Make user"],
    featured: true,
  },
  {
    ...
    ownerName: "Mark Samuelson",
    tags: ["automation", "nlp"],
    requirements: ["HR system access", "Slack bot token", "Make user"],
  },
  {
    ...
    requirements: ["GitHub repository access", "AWS account access", "Legal team approval"],
  },
  {
    ...
    requirements: ["Slack bot token", "License to Claude"],
  },
];
...
export async function seedDatabase(prisma: PrismaClient) {
  ...
  for (const sol of SOLUTIONS) {
    const { tags: tagNames, ownerEmail, featured, requirements, ...data } = sol;
